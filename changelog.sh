# SOURCE=$(curl https://raw.githubusercontent.com/ScratchAddons/contributors/master/README.md)
...
while read -r line1; do
	...
	if [[ $line1 == "<!-- sa-changelog-start -->" ]]; then
		...
		done <<< "$(curl https://raw.githubusercontent.com/ScratchAddons/ScratchAddons/GrahamSH-LLK-changelog/CHANGELOG.md)"
	fi
...
# SOURCE=${RAW_SOURCE%$'\n'*}
# echo $SOURCE
# echo $SOURCE | grep "<!-- ALL-CONTRIBUTORS-LIST:END -->"